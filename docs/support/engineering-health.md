...
[![Tested with jest](https://img.shields.io/badge/tested_with-jest-99424f.svg)](https://www.npmjs.com/package/@websiddu/dnd) [![Tested with cypress](https://img.shields.io/badge/tested%20with-cypress-brightgreen.svg?style=flat)](https://www.cypress.io/)
...
This codebase is designed to be **extremely performant** - it is part of its DNA. It is designed to perform the smallest amount of updates possible. You can have a read about performance work done for `@websiddu/dnd` here:
...
[![minzip](https://img.shields.io/bundlephobia/minzip/@websiddu/dnd.svg)](https://www.npmjs.com/package/@websiddu/dnd)
