...
⚠️ These following community repository are based on [react-beautiful-dnd](https://github.com/atlassian/react-beautiful-dnd) and might not work with future version of [@gsid/dnd](https://github.com/websiddu/dnd).
...
⚠️ This following addon is based on [react-beautiful-dnd](https://github.com/atlassian/react-beautiful-dnd) and might not work with future version of [@gsid/dnd](https://github.com/websiddu/dnd).
